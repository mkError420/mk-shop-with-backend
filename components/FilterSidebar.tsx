        ...
        <div className='h-full lg:h-auto overflow-y-auto bg-white lg:bg-transparent border-r lg:border-0 border-gray-200'>
          ...
          <div className='p-4 lg:p-0 space-y-6'>
            ...
            <div className='border-b border-gray-200 pb-6'>
              ...
              >
                <h4 className='font-semibold text-gray-900 text-lg'>Categories</h4>
                        ...
                        <div className='border-t border-gray-100 bg-gray-50 p-3'>
                          <div className='space-y-2'>
                            {category.subcategories.map(subcategory => (
                              <label key={subcategory.id} className='flex items-center justify-between cursor-pointer p-2 hover:bg-white rounded transition-colors'>
                                <div className='flex items-center'>
                                  <input
                                    type='checkbox'
                                  ...
                                  />
                                  <span className='ml-2 text-xs text-gray-700'>{subcategory.name}</span>
                                </div>
