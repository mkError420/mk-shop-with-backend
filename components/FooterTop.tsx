...
const data: ContactItemData[] = [
  ...
  {
    title: "Working Hours",
    subtitle: "Sat-Thu: 10:00 AM - 9:00 PM",
    icon: (
...
const FooterTop = () => {
  return <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 border-b'>
      {data?.map((item,index)=>(
